...
pub type kmod_start_func_t = extern "C" fn(ki: *mut Struct_kmod_info, data: *mut ::libc::c_void)
                                           -> kern_return_t;
pub type kmod_stop_func_t = extern "C" fn(ki: *mut Struct_kmod_info, data: *mut ::libc::c_void)
                                          -> kern_return_t;
#[repr(C)]
#[derive(Copy)]
